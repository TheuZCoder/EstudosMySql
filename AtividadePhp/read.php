...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search = $_GET['search'];
    $stmt = $pdo->prepare('SELECT * FROM contatos WHERE nome LIKE :search ORDER BY id_contato OFFSET :offset LIMIT :limit');
...
<div class="content read">
    ...
    <form action="read.php" method="GET" class="search-form">
        <input type="text" name="search" placeholder="Pesquisar por nome..." value="<?=isset($_GET['search']) ? htmlentities($_GET['search'], ENT_QUOTES) : ''?>">
